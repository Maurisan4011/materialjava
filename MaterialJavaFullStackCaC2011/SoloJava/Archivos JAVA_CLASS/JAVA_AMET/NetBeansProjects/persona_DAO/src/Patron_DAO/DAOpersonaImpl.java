...
public class DAOpersonaImpl extends Conexion implements DAOpersona{
    ...
    @Override
    public ArrayList<Object[]> listar() throws Exception { //Persona[]
        ArrayList<Object[]> datos = null;//Persona[]
        ...
        try {
            ...
            while (rs.next()) {    
                ...
                for (int i = 0; i < resultadometa.getColumnCount(); i++) {
                    filas[i]= rs.getObject(i+1); //obtiene los datos de la tabla y los mete en las filas
